...
.OP("equal_to", "==", "===", "exactly", "exactly as", "same")
...
.KEYWORD("card_non_number_property", ...CONFIG.CARD_NON_NUMBER_PROPERTIES)
...
.KEYWORD("col", "column")
.KEYWORD("heart")
.KEYWORD("player_name", "player", "players", "enemy", "enemies", "opponent")
